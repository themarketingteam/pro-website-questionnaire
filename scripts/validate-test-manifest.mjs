...
const requiredFoundationFiles = [
  ...
  'config/durable-draft-staging-rollback-drill.json',
  'scripts/lib/staging-rollback-drill.mjs',
  'scripts/precheck-staging-rollback-drill.mjs',
  'scripts/run-synthetic-staging-rollback-drill.mjs',
  'scripts/staging-rollback-drill.test.js',
  'docs/durable-draft-recovery/runbooks/staging-application-rollback-drill-plan.md',
  'docs/durable-draft-recovery/runbooks/base44-domain-transfer-rehearsal-checklist.md',
  'docs/durable-draft-recovery/testing/staging-rollback-drill-certification.md',
