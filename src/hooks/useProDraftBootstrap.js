...
export const useProDraftBootstrap = (options = {}) => {
  ...
  return Object.freeze({
    ...
    listRecoveryChoices: coordinator.listRecoveryChoices,
    selectRecoveryChoice: coordinator.selectRecoveryChoice,
    canListRecoveryChoices: coordinator.canListRecoveryChoices?.() === true,
