...
import { resolveDuplicate } from '../_shared/proDraftMigrationService/entry.ts';

Deno.serve(createAdminFunctionHandler({
  operation: ADMIN_API_OPERATION_NAMES.RESOLVE_MIGRATION_DUPLICATE, maxBytes: 64 * 1024,
